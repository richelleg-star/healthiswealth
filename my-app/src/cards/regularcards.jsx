...
// Handles Firebase arrays-as-objects, real arrays, comma-separated strings, or undefined
...
export function BrowseCards(props){
    ...
    const allclinicinfoTags = toArray(allclinicinfo.Tags)

    const WalkinOrApt = allclinicinfo.needapt === true || allclinicinfo.needapt === "true"
