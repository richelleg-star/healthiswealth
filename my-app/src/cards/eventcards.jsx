...
const openInNewTab = (url) => {
  const newWindow = window.open('https://maps.google.com/?q=305+Harrison+St+Seattle+WA+98109', '_blank', 'noopener,noreferrer')
...
return(
    ...
    <div className="card">
        <div className="card-header">
            <div>
                <h2 className="card-title">Pop-up Flu Shot Clinic</h2>
