...
import { GoogleTranslate } from '../components/GoogleTranslate'; // <-- 1. Import your widget here
    ...
    return(
        <>
            ...
            <nav>
                ...
                {/* 2. Update the language selector div */}
                <div className="language-selector" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                    ...
                    {/* 3. Replace the <select> tag with your component! */}
                    <GoogleTranslate />
                </div>
            </nav>
        </>
